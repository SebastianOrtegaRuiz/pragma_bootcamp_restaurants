...
public class Dishes_OrdersJpaAdapter implements IDishes_OrdersPersistencePort {
    ...
    @Override
    public Dishes_OrdersModel saveDishes_Orders(@Valid Dishes_OrdersModel dishes_ordersModel) {
        Dishes_OrdersEntity dishes_ordersEntity = dishes_ordersRepository.save(dishes_ordersEntityMapper.toEntity(dishes_ordersModel));
